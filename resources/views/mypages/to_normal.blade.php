...
@section('content')
    ...
    <div class="main">
        改行やハイフネーション、特殊記号などがある文章をDeepLで翻訳すると、文字化けが発生する場合や適切な翻訳結果が得られない場合があります。そのような文章でもこちらのツールを利用することで正しい翻訳結果を得ることができます。
        <br>
        また、「5000文字を超えた場合に分割してDeepLで翻訳する」機能を使用することで、DeepLの無料プランでも5000文字以上の長い文章を一発で翻訳することができます。
        <h3>
